    ...
    <div className="about-countainer" id="about">
      <div className="about-desc">
        ...
        <p>
          ...
          explorar distintos escenarios, logrando presentarse en diversos puntos
          del país. Ha compartido su música en reconocidos destinos como Mar del
          Plata (Playa Grande) y Bariloche (Cerro Catedral), además de ser parte
          de eventos organizados por Cloud Producciones, realizados en espacios
          emblemáticos como Altos de Okcidenta, Azopardo Club y Pinta. También
          formó parte de la 14° Bienal de Arte Joven en la Manzana Histórica de
          la UNL, uno de los eventos culturales más relevantes de la región.
        </p>
        <br />
        <p>
          A nivel local, su talento ha sido reconocido en la escena nocturna de
          Santa Fe, donde ha tocado en bares y clubes icónicos como One Six, La
          Grieta, Monkey Bar, Peñón del Águila, Liverpool y Hammer, así como en
          paradores de playa y eventos privados tanto en Santa Fe como en
          Gualeguaychú. Su capacidad para leer la pista y construir sets
          dinámicos lo ha llevado a consolidarse como una figura en ascenso
          dentro del circuito electrónico nacional.
        </p>
        <br />
        <p>
          ...
          una cuidadosa selección de sonidos y una estética pulida, busca
          transportar al oyente a un viaje sensorial único.
        </p>
        <br />
        <p>
